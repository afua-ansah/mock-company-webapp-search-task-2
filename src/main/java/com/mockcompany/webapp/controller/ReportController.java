...
public class ReportController {
    ...
    public SearchReportResponse runReport() {
        ...
        Collection<ProductItem> kidMatches = searchService.searchMatches(allItems, "kids");
        Collection<ProductItem> perfectMatches = searchService.searchMatches(allItems, "perfect");
        
        int kidCount = kidMatches.size();
        int perfectCount = perfectMatches.size();
